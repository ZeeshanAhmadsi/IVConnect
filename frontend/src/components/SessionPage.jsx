...
function SessionPage() {
  ...
  // Auto-join the session when the user clicks "Rejoin"
  // This useEffect checks the session and automatically joins
  // if the user is not already a participant and is not the host.
  useEffect(() => {
  ...
  //redirect the "participant" to dashboard when session ends
  useEffect(() => {
        ...
        <PanelGroup direction="horizontal">
          ...
          <Panel defaultSize={50} minSize={30}>
            <PanelGroup direction="vertical">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        >
                          {session?.difficulty.slice(0, 1).toUpperCase() +
                            session?.difficulty.slice(1).toUpperCase() ||
                            "Easy"}
                        </span>
                            ...
                            {problemData.examples.map((example, idx) => (
                              <div key={idx}>
                                ...
                                <div className="bg-base-200 rounded-lg p-4 font-mono text-sm space-y-1.5">
                                  ...
                                  <div className="flex gap-2">
                                    <span className="text-emerald-600 font-bold min-w-[70px]">
                                      Output:
                                    </span>
              ...
              {/*Code Editor panel while video calling*/}
              <Panel defaultSize={50} minSize={20}>
                <PanelGroup direction="vertical">
                  ...
                  <PanelResizeHandle
                    className="h-2 bg-base-300  hover:bg-emerald-500 
                ...
                <div className="h-full flex items-center justify-center">
                  <div className="card bg-base-100 shadow-xl max-w-md">
                    <div className="card-body items-center text-center">
                      <div className="w-24 h-24 bg-error/10 rounded-full flex items-center
                      justify-center mb-4">
