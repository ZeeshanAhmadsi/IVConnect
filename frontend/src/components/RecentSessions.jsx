...
/**
 * Render a responsive card that lists past coding sessions and handles loading and empty states.
 *
 * Each session item displays status (including an active badge), problem title, difficulty badge,
 * time since creation, participant count, and last-updated date.
 *
 * @param {Array<Object>} sessions - Array of session objects. Each session is expected to include:
 *   - {_id: string} unique identifier
 *   - {string} status ("active" or other)
 *   - {string} problem
 *   - {string} difficulty
 *   - {string|Date} createdAt
 *   - {string|Date} updatedAt
 *   - {boolean} participant
 * @param {boolean} isLoading - When true, displays a centered loading indicator instead of sessions.
 * @returns {JSX.Element} The RecentSessions card element.
 */
