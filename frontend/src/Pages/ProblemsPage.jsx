import { ChevronsRight, ChevronsRightIcon, Code2Icon} from "lucide-react";
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex-1">
              <div className=" flex items-center gap-3 mb-2">
                ...
                <div className="size-12 rounded-lg bg-emerald-700/10 flex items-center justify-center">
                  <Code2Icon className="size-6 text-emerald-600"/>
                </div>
              ...
              <p className="text-sm text-base-content/80">{problem.description.text}</p>
            </div>
            {/*Right Side*/}
      ...
      <div className="card-body">
        <div className="stats stats-vertical lg:stats-horizontal">
          ...
          <div className="stat">
            ...
            <div className="stat-value text-emerald-600">{problems.length}</div>
          </div>
